...
"""Solves magnetic wave propagation in the sheet under the influence of magnetic field from the magnets."""
...
class MMSolver(nn.Module):
    ...
    def forward(self, signal, rho):
        ...
        if isinstance(self.geom, WaveGeometryMs):
            ...
            B_ext = self.geom(rho) #B_ext is magnetic field from magnets
            Msat = self.geom.Ms_sheet
